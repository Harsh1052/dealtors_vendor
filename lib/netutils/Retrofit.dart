...
signup(String name, String email, String mobile_no,String otp) {
  return http.post(
      url + "service_user.php?" + secure_field + "=" + secure_value + "&" +
          secure_service + "=" + "2",
      body: {
  'appFlag':"1",
  'first_name': name,
...
editProfile(String id, String name, String email, String mobile_no) {
  print(url + "service_vendor.php?" + secure_field + "=" + secure_value + "&" +
      secure_service + "=" + "30" + '&id=' + id + '&first_name=' + name +
      '&email_address=' + email + '&mobile_no=' + mobile_no);
  return http.post(
      url + "service_vendor.php?" + secure_field + "=" + secure_value + "&" +
          secure_service + "=" + "30",
      body: {
        'id': id,
        'first_name': name,
...
editBussiness(String id, String name, String email, String mobile_no,
    String business_category_id,
    String business_name, String about_business, String business_contact_no,
    String business_location,
    String business_area, String business_landmark, String opening_time,
    String closing_time) {
  print(url + "service_user.php?" + secure_field + "=" + secure_value + "&" +
      secure_service + "=" + "3" + "&id=" + id + '&first_name=' + name +
      '&email_address=' + email +
      '&mobile_no=' + mobile_no + '&business_category_id=' +
      business_category_id + '&business_name=' + business_name +
      '&about_business=' + about_business
      + '&business_contact_no=' + business_contact_no + '&business_location=' +
      business_location + '&business_area=' + business_area +
...
editBussinessWithImage(String id, String name, String email, String mobile_no,
    String business_category_id,
    String business_name, String about_business, String business_contact_no,
    String business_location,
    String business_area, String business_landmark, String opening_time,
    String closing_time, String image_path) {
  print(url + "service_user.php?" + secure_field + "=" + secure_value + "&" +
      secure_service + "=" + "3" + "&id=" + id + '&first_name=' + name +
      '&email_address=' + email +
      '&mobile_no=' + mobile_no + '&business_category_id=' +
...
getCategory(String uid /*,String ll,String ul*/) {
  print( url + "service_user.php?" + secure_field + "=" + secure_value + "&" +
      secure_service + "=" + "10"+'&appFlag=1'/*+'&ll='+ll+'&ul='+ul*/);
  return http.post(
      url + "service_user.php?" + secure_field + "=" + secure_value + "&" +
          secure_service + "=" + "10",
      body: {'uid': uid, 'appFlag': "1"/* ,'ll':ll,'ul':ul*/
      });
}

getLiveCoupon(String uid, String ll, String ul) {
  print(url + "service_user.php?" + secure_field + "=" + secure_value + "&" +
      secure_service + "=" + "11" + "&appFlag=1&flag=1&vendor_id=" + uid +
      "&ll=" + ll + "&ul=" + ul);
  return http.post(
      url + "service_user.php?" + secure_field + "=" + secure_value + "&" +
          secure_service + "=" + "11",
...
editCoupon(String uid, String title, String des, String start_date,
  ...
  print(url + "service_user.php?" + secure_field + "=" + secure_value + "&" +
      secure_service + "=" + "14" + '&appFlag=1' + '&id=' + id + '&vendor_id=' +
      uid + '&title=' + title + '&description=' + des + '&start_date=' +
      start_date + '&expiry_date=' + expiry_date);
...
verifyCoupon(String user_id, String coupon_code, String bill_amount) {
  print(url + "service_general.php?" + secure_field + "=" + secure_value + "&" +
      secure_service + "=" + "18" + '&vendor_id=' + user_id + '&coupon_code=' +
      coupon_code + '&bill_amount=' + bill_amount);
  return http.post(
      url + "service_general.php?" + secure_field + "=" + secure_value + "&" +
          secure_service + "=" + "18",
      body: {
        'vendor_id': user_id,
...
getUsedCoupon(String user_id, String ll, String ul) {
  return http.post(
      url + "service_general.php?" + secure_field + "=" + secure_value + "&" +
          secure_service + "=" + "19",
      body: {'vendor_id': user_id, 'isUsed': "1", 'll': ll, 'ul': ul,'appFlag':"1"});
}
...
couponStatus(String user_id, coupon_id, String status) {
  return http.post(
      url + "service_vendor.php?" + secure_field + "=" + secure_value + "&" +
          secure_service + "=" + "29",
      body: {'vendor_id': user_id, 'id': coupon_id, 'status': status,'appFlag':"1"});
